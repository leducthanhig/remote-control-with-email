...
#define GOOGLE_AUTHORIZATION_URL        "https://accounts.google.com/o/oauth2/auth"
#define GOOGLEAPI_AUTH_TOKEN_URL        "https://oauth2.googleapis.com/token"
...
string refreshAccessToken() {
    ...
    string url = GOOGLEAPI_AUTH_TOKEN_URL,
...
string getAuthorizationCode() {
    // Ask for a valid authorization code
    char alreadyHave;
    ...
    if (tolower(alreadyHave) == 'y') {
        ...
        string client_id = credentials["client_id"], 
               ...
               url = GOOGLE_AUTHORIZATION_URL"?client_id=" + client_id + "&redirect_uri=" + redirect_uri 
                    + "&response_type=code&scope=" + GOOGLEAPI_AUTH_SCOPE_URL;
        // Give user the url to login to a Google Account and get an authorization code
        ...
        // Get the url that contains the authorization code from user
        string urlWithCode;
        cin >> urlWithCode;
...
string getAccessToken() {
    ...
    // Check if successfully getting the access token
